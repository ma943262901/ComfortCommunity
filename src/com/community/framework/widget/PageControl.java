...
package com.community.framework.widget;
...
public class PageControl extends LinearLayout {
				...
				if (mOnPageControlClickListener != null) {
					...
					case MotionEvent.ACTION_UP:
						...
						if (PageControl.this.getOrientation() == LinearLayout.HORIZONTAL) {
							if (event.getX() < (PageControl.this.getWidth() / 2)) // if
																					// on
																					// left
																					// of
																					// view
							...
							if (event.getY() < (PageControl.this.getHeight() / 2)) // if
																					// on
																					// top
																					// half
																					// of
	...
	public void setPageCount(int pageCount) {
		...
		for (int i = 0; i < pageCount; i++) {
			...
			params.setMargins(mIndicatorSize / 2 + 10, mIndicatorSize,
					mIndicatorSize / 2 + 10, mIndicatorSize);
	...
	public void setCurrentPage(int currentPage) {
		if (currentPage < mPageCount) {
			indicators.get(mCurrentPage)
					.setBackgroundDrawable(inactiveDrawable);// reset old
																// indicator
			indicators.get(currentPage).setBackgroundDrawable(activeDrawable);// set
																				// up
																				// new
																				// indicator
